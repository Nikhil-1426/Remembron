...
// //       color: Color.fromRGBO(252, 253, 252, 1), fontSize: 25),
// //       ),
// //       ),      
...
// //                   child: Text("Sign Up"),
// //                   style: ButtonStyle(
// //                     backgroundColor: MaterialStateProperty.all(Color.fromARGB(255, 58, 224, 224)),
// //                   ),
// //                 ),
// //                 SizedBox(height: 20),
// //                 Row(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          "Sign Up",
          style: TextStyle(color: Color.fromRGBO(252, 253, 252, 1), fontSize: 20),
        ),
      ),
      body: SingleChildScrollView(
        child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  style: ButtonStyle(
                    backgroundColor: MaterialStateProperty.all(Color.fromARGB(255, 4, 53, 216)),
                  ),
                ),
                SizedBox(height: 20),
                Row(
