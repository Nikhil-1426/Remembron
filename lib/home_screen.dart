    ...
    return MaterialApp(
        ...
        theme: ThemeData(
          appBarTheme: AppBarTheme(
            color: Color.fromARGB(255, 94, 188, 188),
          ),
        ),
        home: Scaffold(
          backgroundColor: Color.fromARGB(255, 142, 225, 225),
          appBar: AppBar(
                ...
                Row(
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        _buildUserInfo("User Name :", "John Doe"),
                        _buildUserInfo("Age :", "25"),
                        _buildUserInfo("Gender :", "Male"),
                      ],
                    ),
                  ],
                ),
  ...
  Widget _buildReminderBox(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(8),
          color: Color.fromARGB(255, 102, 178, 178),
        ),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
